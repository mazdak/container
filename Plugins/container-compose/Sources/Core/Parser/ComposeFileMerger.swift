...
public struct ComposeFileMerger {
    ...
    private func mergeTwoFiles(base: ComposeFile, override: ComposeFile) -> ComposeFile {
        ...
        let name = override.name ?? base.name
        let include = mergeIncludes(base: base.include, override: override.include)
    ...
    private func mergeIncludes(base: [ComposeInclude]?, override: [ComposeInclude]?) -> [ComposeInclude]? {
