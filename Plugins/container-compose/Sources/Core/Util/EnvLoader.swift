...
public struct EnvLoader {
    public static func load(from directory: URL, export: Bool = true, override: Bool = false, logger: Logger? = nil) -> [String: String] {
        ...
        return load(fileURL: envURL, export: export, override: override, logger: logger)
    }

    public static func load(fileURL envURL: URL, export: Bool = true, override: Bool = false, logger: Logger? = nil) -> [String: String] {
