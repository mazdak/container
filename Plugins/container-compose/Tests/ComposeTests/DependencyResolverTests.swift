...
struct DependencyResolverTests {
    ...
    @Test
    func testResolveWithinSelectionPreservesDependencyOrder() throws {
        let services: [String: Service] = [
        ...
        let resolution = try DependencyResolver.resolveWithinSelection(services: services)
    ...
    @Test
    func testResolveWithinSelectionIgnoresDependenciesOutsideSelection() throws {
        let services: [String: Service] = [
            "web": Service(name: "web", image: "nginx", dependsOnHealthy: ["db"])
        ]
